...
describe('Server module tests', function() {
  ...
  describe('DELETE method', function() {
    ...
    describe('it should delete the item', function() {
      ...
      // it('should successfully remove the title when provided an id', done => {
      //   chai.request(server)
      //   .del(`/api/album?id=${testDelete.id}`)
      //   .end((err) => {
      //     if (err) console.error(err);
      //     expect(testDelete.title).to.be.empty;
      //     done();
      //   });
      // });
      // 
      // it('should successfully remove the year when provided an id', done => {
      //   chai.request(server)
      //   .del(`/api/album?id=${testDelete.id}`)
      //   .end((err) => {
      //     if (err) console.error(err);
      //     expect(testDelete.year).to.be.empty;
      //     done();
      //   });
      // });
